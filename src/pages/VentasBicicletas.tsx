  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-slate-800">Ventas de Bicicletas</h1>
          <p className="text-slate-500 mt-1">Registro de ventas y control de rentabilidad</p>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-xl w-full max-w-4xl my-8">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              {selectedBiciId && bicicletaSeleccionada && (
                <div className="bg-slate-50 rounded-lg p-4 border border-slate-200">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-4 text-sm">
                    ...
                    <div className={`border-l border-slate-300 pl-2 ${rentabilidad >= 0 ? 'text-green-700' : 'text-red-700'}`}>
              ...
              <div className="border-t border-slate-200 pt-4">
                ...
                {pagos.map((pago) => (
                  <div key={pago.id} className="flex gap-2 mb-2 items-end">
                    ...
                    {pagos.length > 1 && (
                      <button type="button" onClick={() => eliminarPago(pago.id)} className="p-2 text-red-500 hover:bg-red-50 rounded"><Trash2 className="w-4 h-4" /></button>
                    )}
                  </div>
                ))}
              ...
              <div className="flex justify-end gap-2 pt-4 border-t border-slate-200">
                ...
                <button type="submit" disabled={procesando || !pagosCuadrados} className="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 flex items-center gap-2 disabled:opacity-50">
